...
import com.example.limaoi.gameone.adapter.KgVideoItemAdapter;
...
public class KingGloryVideoFragment extends BaseFragment implements View.OnClickListener {

    public static String TABLAYOUT_FRAGMENT = "KingGloryVideoFragment";
    private PtrClassicFrameLayout mPtrLayout;
    private ArrayList<Video> videoList = new ArrayList<>();
    private RecyclerViewFinal mRecyclerViewFinal;
    private KgVideoItemAdapter mVideoItemAdapter;
    private JZVideoPlayerStandard jzVideoPlayer;
    private int mPage = 1;

    public static KingGloryVideoFragment newInstance(int type) {
        KingGloryVideoFragment fragment = new KingGloryVideoFragment();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_gl_video, container, false);
    ...
    private void initEvents() {
        ...
        mVideoItemAdapter = new KgVideoItemAdapter(videoList);
        mRecyclerViewFinal.setAdapter(mVideoItemAdapter);
        mVideoItemAdapter.setOnItemClickListener(new KgVideoItemAdapter.OnItemClickListener() {
            @Override
    ...
    private void loadingData() {
        ...
        query.setLimit(5);
        query.addWhereEqualTo("label", "王者荣耀");
